...
public class LogConsultasModel {
    ...
    public LogConsultasModel(int id, LocalDateTime dataInclusao, TransportadoraModel transportadora,
            ...
            String checkList, String rota, String sm, LocalDateTime dataFinalizacao, 
